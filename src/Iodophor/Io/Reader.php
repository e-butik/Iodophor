...
/**
 * The Iodophor\Io\Reader class represents a character stream providing means to
...
class Reader
{
    ...
    /**
     * Constructs the Iodophor\Io\Reader class with given open file descriptor.
     *
     * @param resource $fd The file descriptor.
     * @throws Iodophor\Io\Exception if given file descriptor is not valid
     */
     ...
     *
     * @return boolean
     * @throws Iodophor\Io\Exception if an I/O error occurs
     */
     ...
     * @return void
     * @throws Iodophor\Io\Exception if <var>size</var> attribute is negative or if
     *  an I/O error occurs
     */
     ...
     * @return string
     * @throws Iodophor\Io\Exception if <var>length</var> attribute is negative or
