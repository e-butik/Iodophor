...
/**
 * The Iodophor\Io\StringWriter represents a character stream whose source is
 * a string.
 *
...
{
    /**
     * Constructs the Iodophor\Io\StringWriter class with given source string.
     *
    ...
    public function __construct($data = null, $length = null)
    {
        if (($this->_fd = fopen('php://memory', 'w+b')) === false) {
            throw new IoException('Unable to open php://memory stream');
        }
