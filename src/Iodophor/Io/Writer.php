...
/**
 * The Iodophor\Io\Writer class represents a character stream providing means to
...
class Iodophor\Io\Writer
{
    ...
    /**
     * Constructs the Iodophor\Io\Writer class with given open file descriptor.
     *
     * @param resource $fd The file descriptor.
     * @throws Iodophor\Io\Exception if file descriptor is not valid
     */
     ...
     *
     * @return integer
     * @throws Iodophor\Io\Exception if the stream is closed
     */
